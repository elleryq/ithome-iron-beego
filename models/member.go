...
// Id doesn't exist
func GetMemberById(id int64) (v *Member, err error) {
	o := orm.NewOrm()
	v = &Member{Id: id}
	if err = o.QueryTable(new(Member)).Filter("Id", id).RelatedSel().One(v); err == nil {
		return v, nil
	}
	return nil, err
}
...
func DeleteMember(id int64) (err error) {
	o := orm.NewOrm()
	v := Member{Id: id}
	// ascertain id exists in the database
	if err = o.Read(&v); err == nil {
